 ...
 * Disclaimer: modules in _shims aren't intended to be imported by SDK users.
 */
__exportStar(__nccwpck_require__(6938), exports);
 ...
 * Disclaimer: modules in _shims aren't intended to be imported by SDK users.
 */
const shims = __nccwpck_require__(9320);
const auto = __nccwpck_require__(364);
exports.init = () => {
...
const MultipartBody_1 = __nccwpck_require__(7475);
...
function setShims(shims, options = { auto: false }) {
    ...
    if (exports.kind) {
        throw new Error(`can't \`import '@valtown/sdk/shims/${shims.kind}'\` after \`import '@valtown/sdk/shims/${exports.kind}'\``);
    }
...
const version_1 = __nccwpck_require__(2669);
const error_1 = __nccwpck_require__(8191);
const index_1 = __nccwpck_require__(4375);
// try running side effects outside of _shims/index to workaround https://github.com/vercel/next.js/issues/76881
(0, index_1.init)();
const uploads_1 = __nccwpck_require__(7847);
var uploads_2 = __nccwpck_require__(7847);
...
class APIClient {
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new error_1.ValTownError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
...
class AbstractPage {
    ...
    async getNextPage() {
        ...
        if (!nextInfo) {
            throw new error_1.ValTownError('No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.');
        }
...
const validatePositiveInteger = (name, n) => {
    if (typeof n !== 'number' || !Number.isInteger(n)) {
        throw new error_1.ValTownError(`${name} must be an integer`);
    }
    if (n < 0) {
        throw new error_1.ValTownError(`${name} must be a positive integer`);
    }
    return n;
};
...
const ensurePresent = (value) => {
    if (value == null)
        throw new error_1.ValTownError(`Expected a value to be given but received ${value} instead.`);
    return value;
};
...
const coerceInteger = (value) => {
    ...
    throw new error_1.ValTownError(`Could not coerce ${value} (type: ${typeof value}) into a number`);
};
...
const toBase64 = (str) => {
    ...
    throw new error_1.ValTownError('Cannot generate b64 string; Expected `Buffer` or `btoa` to be defined');
};
...
const core_1 = __nccwpck_require__(5034);
class ValTownError extends Error {
}
exports.ValTownError = ValTownError;
...
const Core = __importStar(__nccwpck_require__(5034));
const Errors = __importStar(__nccwpck_require__(8191));
const Pagination = __importStar(__nccwpck_require__(1369));
const Uploads = __importStar(__nccwpck_require__(7847));
const API = __importStar(__nccwpck_require__(6411));
const blobs_1 = __nccwpck_require__(7599);
const emails_1 = __nccwpck_require__(7050);
const sqlite_1 = __nccwpck_require__(3395);
const alias_1 = __nccwpck_require__(2168);
const me_1 = __nccwpck_require__(926);
const projects_1 = __nccwpck_require__(2734);
const search_1 = __nccwpck_require__(4750);
const users_1 = __nccwpck_require__(8840);
const vals_1 = __nccwpck_require__(4410);
/**
 * API Client for interfacing with the Val Town API.
 */
class ValTown extends Core.APIClient {
    /**
     * API Client for interfacing with the Val Town API.
     *
     ...
     */
    constructor({ baseURL = Core.readEnv('VAL_TOWN_BASE_URL'), bearerToken = Core.readEnv('VAL_TOWN_API_KEY'), ...opts } = {}) {
        if (bearerToken === undefined) {
            throw new Errors.ValTownError("The VAL_TOWN_API_KEY environment variable is missing or empty; either provide it, or instantiate the ValTown client with an bearerToken option, like new ValTown({ bearerToken: 'My Bearer Token' }).");
        }
        const options = {
            bearerToken,
            ...opts,
...
_a = ValTown;
ValTown.ValTown = _a;
ValTown.DEFAULT_TIMEOUT = 60000; // 1 minute
ValTown.ValTownError = Errors.ValTownError;
ValTown.APIError = Errors.APIError;
ValTown.APIConnectionError = Errors.APIConnectionError;
ValTown.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
ValTown.APIUserAbortError = Errors.APIUserAbortError;
ValTown.NotFoundError = Errors.NotFoundError;
ValTown.ConflictError = Errors.ConflictError;
ValTown.RateLimitError = Errors.RateLimitError;
ValTown.BadRequestError = Errors.BadRequestError;
ValTown.AuthenticationError = Errors.AuthenticationError;
ValTown.InternalServerError = Errors.InternalServerError;
ValTown.PermissionDeniedError = Errors.PermissionDeniedError;
ValTown.UnprocessableEntityError = Errors.UnprocessableEntityError;
ValTown.toFile = Uploads.toFile;
ValTown.fileFromPath = Uploads.fileFromPath;
ValTown.Search = search_1.Search;
ValTown.Alias = alias_1.Alias;
ValTown.Me = me_1.Me;
...
ValTown.Projects = projects_1.Projects;
ValTown.ProjectListResponsesPageCursorURL = projects_1.ProjectListResponsesPageCursorURL;
var uploads_1 = __nccwpck_require__(7847);
Object.defineProperty(exports, "toFile", ({ enumerable: true, get: function () { return uploads_1.toFile; } }));
Object.defineProperty(exports, "fileFromPath", ({ enumerable: true, get: function () { return uploads_1.fileFromPath; } }));
var error_1 = __nccwpck_require__(8191);
Object.defineProperty(exports, "ValTownError", ({ enumerable: true, get: function () { return error_1.ValTownError; } }));
...
exports = module.exports = ValTown;
exports["default"] = ValTown;
...
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.PageCursorURL = void 0;
const core_1 = __nccwpck_require__(5034);
class PageCursorURL extends core_1.AbstractPage {
    constructor(client, response, body, options) {
...
exports.PageCursorURL = PageCursorURL;
...
const resource_1 = __nccwpck_require__(2849);
const UsernameAPI = __importStar(__nccwpck_require__(5109));
const username_1 = __nccwpck_require__(5109);
/**
 * Methods to translate between human-readable names and IDs
 */
class Alias extends resource_1.APIResource {
    constructor() {
        super(...arguments);
        this.username = new UsernameAPI.Username(this._client);
    }
}
exports.Alias = Alias;
Alias.Username = username_1.Username;
...
const resource_1 = __nccwpck_require__(2849);
const ProjectNameAPI = __importStar(__nccwpck_require__(9198));
const project_name_1 = __nccwpck_require__(9198);
const ValNameAPI = __importStar(__nccwpck_require__(8704));
const val_name_1 = __nccwpck_require__(8704);
...
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ValName = void 0;
const resource_1 = __nccwpck_require__(2849);
class ValName extends resource_1.APIResource {
    /**
     * Get a val
     */
...
exports.ValName = ValName;
//# sourceMappingURL=val-name.js.map
...
var search_1 = __nccwpck_require__(4750);
Object.defineProperty(exports, "Search", ({ enumerable: true, get: function () { return search_1.Search; } }));
var sqlite_1 = __nccwpck_require__(3395);
Object.defineProperty(exports, "Sqlite", ({ enumerable: true, get: function () { return sqlite_1.Sqlite; } }));
var users_1 = __nccwpck_require__(8840);
Object.defineProperty(exports, "Users", ({ enumerable: true, get: function () { return users_1.Users; } }));
var vals_1 = __nccwpck_require__(4410);
...
const resource_1 = __nccwpck_require__(2849);
const pagination_1 = __nccwpck_require__(1369);
...
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BasicValsPageCursorURL = exports.Likes = void 0;
const resource_1 = __nccwpck_require__(2849);
const shared_1 = __nccwpck_require__(1366);
...
class Likes extends resource_1.APIResource {
     ...
     */
    list(query, options) {
        return this._client.getAPIList('/v1/me/likes', shared_1.BasicValsPageCursorURL, { query, ...options });
    }
}
exports.Likes = Likes;
...
exports.Me = void 0;
const resource_1 = __nccwpck_require__(2849);
const CommentsAPI = __importStar(__nccwpck_require__(3190));
const comments_1 = __nccwpck_require__(3190);
const LikesAPI = __importStar(__nccwpck_require__(7450));
const likes_1 = __nccwpck_require__(7450);
const ProfileAPI = __importStar(__nccwpck_require__(6923));
const profile_1 = __nccwpck_require__(6923);
const ProjectsAPI = __importStar(__nccwpck_require__(3786));
const projects_1 = __nccwpck_require__(3786);
const ReferencesAPI = __importStar(__nccwpck_require__(6602));
const references_1 = __nccwpck_require__(6602);
/**
 * Methods to get information about your own profile and resources
 */
...
exports.Me = Me;
Me.Profile = profile_1.Profile;
Me.Likes = likes_1.Likes;
Me.Comments = comments_1.Comments;
...
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ReferenceListResponsesPageCursorURL = exports.References = void 0;
const resource_1 = __nccwpck_require__(2849);
const pagination_1 = __nccwpck_require__(1369);
...
class ReferenceListResponsesPageCursorURL extends pagination_1.PageCursorURL {
}
exports.ReferenceListResponsesPageCursorURL = ReferenceListResponsesPageCursorURL;
...
class Branches extends resource_1.APIResource {
     ...
     */
    delete(projectId, branchId, options) {
...
exports.ProjectListResponsesPageCursorURL = exports.Projects = void 0;
const resource_1 = __nccwpck_require__(2849);
const BranchesAPI = __importStar(__nccwpck_require__(908));
const branches_1 = __nccwpck_require__(908);
const FilesAPI = __importStar(__nccwpck_require__(5977));
const files_1 = __nccwpck_require__(5977);
const pagination_1 = __nccwpck_require__(1369);
/**
 * Projects let you organize multiple files and collaborate with pull requests
 */
...
Projects.FileRetrieveResponsesPageCursorURL = files_1.FileRetrieveResponsesPageCursorURL;
//# sourceMappingURL=projects.js.map
...
const resource_1 = __nccwpck_require__(2849);
const ValsAPI = __importStar(__nccwpck_require__(2746));
const vals_1 = __nccwpck_require__(2746);
/**
 * Search endpoint for vals
 */
class Search extends resource_1.APIResource {
    constructor() {
        super(...arguments);
        this.vals = new ValsAPI.Vals(this._client);
    }
}
exports.Search = Search;
Search.Vals = vals_1.Vals;
...
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BasicValsPageCursorURL = void 0;
const pagination_1 = __nccwpck_require__(1369);
...
const resource_1 = __nccwpck_require__(2849);
const ValsAPI = __importStar(__nccwpck_require__(4662));
const vals_1 = __nccwpck_require__(4662);
/**
 * Access public user information and list other people’s vals
 */
...
class Vals extends resource_1.APIResource {
    ...
    list(userId, query, options) {
        return this._client.getAPIList(`/v1/users/${userId}/vals`, shared_1.BasicValsPageCursorURL, { query, ...options });
    }
}
exports.Vals = Vals;
//# sourceMappingURL=vals.js.map
...
const resource_1 = __nccwpck_require__(2849);
const core_1 = __nccwpck_require__(5034);
const VersionsAPI = __importStar(__nccwpck_require__(9935));
const versions_1 = __nccwpck_require__(9935);
/**
 * Vals are runnable JavaScript, TypeScript, and JSX modules
 */
class Vals extends resource_1.APIResource {
...
const index_1 = __nccwpck_require__(4375);
var index_2 = __nccwpck_require__(4375);
